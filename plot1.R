...
# create histogram for Global Active Power and save it to a png file
png(filename = "plot1.png")
hist(february_data$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
dev.off()
